...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 0)), "Novo Estudante", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 102, 153))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bacharelado", "Licenciatura", "Especialização", "Mestrado Acadêmico", " " }));
        ...
        setSize(new java.awt.Dimension(307, 317));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql = "insert into Estudante(ID_Estudante,Nome,Pai,Curso,Ramo,Ano,Semestre) values (?,?,?,?,?,?,?)";
        try {
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Estudante registrado!");
        } catch(Exception e) {
